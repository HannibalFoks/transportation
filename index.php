...
<main class="main-box">
        ...
        <div class="header__item1">
            <div class="header__item1__elems flex-group_sp-btvn">
                <div class="header__item1__lang flex-group_sp-btvn">
                    <div class="header__item1__lang__elem header__elem">
                        <a href="#">РУС</a>
                    </div>
                    <div class="header__item1__lang__elem header__elem">
                        <a href="#">ENG</a>
    ...
    <section class="presentation flex-group_sp-btvn">
        <div class="presentation__info flex-group_column">
            <h1 class="presentation__info__elem1">Грузовые перевозки</h1>
            <span class="presentation__info__elem2 _style-text-l">
    ...
    <section id="services">
        <div class="fon2 fon2_left"></div>
        <div class="fon2 fon2_right"></div>
        <div class="section-size flex-group_sp-btvn">
            <div class="services_item1 flex-group_column">
                <div class="services_item1__elem1"></div>
                <div class="services_item1__elem2">
                    грузоперевозки<br>
                    по европе
                </div>
                <div class="services_item1__elem3 _style-text-l ">
                    Страны Евросоюза, а также Украина,<br>
                    Белоруссия со всеми документами.
                </div>
                <a href="#" class="services_item1__a _style-text-bott ">
                    <div class="services_item1__elem4">ПОДРОБНЕЕ</div>
                </a>
            </div>
            <div class="services_item2">
                <img src="imag/truck.png" alt="">
            </div>
            <div class="services_item3 flex-group_column">
                <div class="services_item3__next flex-group_sp-btvn">
                    <span class="services__direction _style-text-m"><a href="#">след</a></span>
                    <a href="#"><img class="services__arrows" src="imag/next.png" alt=""></a>
                </div>
                <div class="services_item3__back flex-group_sp-btvn">

                    <a href="#"><img class="services__arrows" src="imag/back.png" alt=""></a>
                    <span class="services__direction _style-text-m"><a href="#">Назад</a></span>
                </div>
            </div>
        </div>
    </section>
    <section id="provide" class="section-size">
        <div class="section-top flex-group_column">
            <div class="services_item1__elem1"></div>
            <div class="services_item1__elem2">
                услуги
            </div>
        </div>
        <div class="provide__main-box">
            <div class="provide__stripe flex-group_sp-btvn">

                <a href="#">
                    <div class="provide__elem provide__elem__activ flex-group_column">
                        <div class="provide__elem__activ__imag">
                            <img src="imag/Vector(1).png" alt="">
                        </div>
